      ...
      <Box sx={{ height: "100dvh", overflow: "clip", display: "flex", flexDirection: "column", bgcolor: "background.default", color: "#1e293b" }}>
        ...
        <Box sx={{ display: "flex", flex: 1, minHeight: 0 }}>
          ...
          <SidebarFilters
            ...
            onLogout={() => sessionState.handleLogout(afterLogout)}
          />
        ...
        >
          ...
          <DialogContent sx={{ pt: 0, pb: 2 }}>
            <Typography sx={{ fontSize: 13, color: "#475569" }}>이 아티클을 삭제할까요?</Typography>
          ...
          <DialogActions sx={{ px: 2, pb: 2, pt: 0, gap: 1 }}>
            <Button size="small" variant="outlined" disabled={articleState.mutatingArticleId !== null} onClick={() => setPendingDeleteCard(null)} sx={{ fontSize: 13, borderRadius: 1.5, borderColor: "#e2e8f0", color: "#475569", "&:hover": { borderColor: "#cbd5e1", bgcolor: "transparent" } }}>
              취소
            </Button>
            <Button size="small" variant="contained" disabled={articleState.mutatingArticleId !== null} onClick={async () => { if (!pendingDeleteCard) return; await articleState.handleDelete(pendingDeleteCard); setPendingDeleteCard(null); }} sx={{ fontSize: 13, borderRadius: 1.5, bgcolor: "#ef4444", "&:hover": { bgcolor: "#dc2626" }, boxShadow: "none" }}>
        ...
        >
          ...
          <DialogActions sx={{ px: 2, pb: 2, pt: 0, gap: 1 }}>
            <Button size="small" variant="outlined" disabled={isBulkDeleting} onClick={() => setIsBulkDeleteConfirmOpen(false)} sx={{ fontSize: 13, borderRadius: 1.5, borderColor: "#e2e8f0", color: "#475569", "&:hover": { borderColor: "#cbd5e1", bgcolor: "transparent" } }}>
              취소
            </Button>
            <Button size="small" variant="contained" disabled={isBulkDeleting} onClick={() => void handleBulkDeleteConfirm()} sx={{ fontSize: 13, borderRadius: 1.5, bgcolor: "#ef4444", "&:hover": { bgcolor: "#dc2626" }, boxShadow: "none" }}>
